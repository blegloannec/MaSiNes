...
*Lightweight* as the core simulation function is 40 lines long; the remaining ~300 lines deal with modular structuring, input parsing and output generation in several formats.
